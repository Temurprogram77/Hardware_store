      ...
      {/* Breadcrumb */}
        ...
        <div className='flex gap-4'>
          <div className='flex flex-col gap-2.5'>
            ...
            <ul className='relative left-8'>
              <li className='list-disc !hover:text-[#1e1e1e] marker:text-red-500 '>Производится доставка только после подтверждения о готовности получить товар. В день доставки просим оставаться на связи в согласованное время по указанному в заказе номеру телефона;</li>
            ...
            <p className=''>После приема товара претензии покупателя, касающиеся комплектации и механических повреждений товара, не принимаются.</p>
          </div>
              <Advertisement/>
        </div>
