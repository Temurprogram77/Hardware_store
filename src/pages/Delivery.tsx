      ...
      {/* Breadcrumb */}
        ...
        <div className='flex gap-4'>
          <div className='flex flex-col gap-2.5'>
            ...
            <p className='text-[#003b73] relative left-[33px]'>После приема товара претензии покупателя, касающиеся комплектации и механических повреждений товара, не принимаются.</p>
          </div>
              <Advertisement/>
        </div>
