  ...
  return (
    <div className="flex justify-center items-center md:mb-8">
      <div className="md:pr-4 md:pl-4 pl-[10px] overflow-x-hidden mt-5 w-[1490px] max-md:w-[355px]">
        ...
        <h1 className="!font-bold !mt-5 text-[32px] text-[#2c333d] md:text-[40px] lg:text-[48px]">
          Доставка
        </h1>
        <div className="block gap-4 md:flex">
          <div className="flex flex-col gap-2.5 w-[95%] lg:w-[1000px]">
            ...
            <p className="md:text-[15px] text-[#1e1e1e] leading-6 font-sans text-[19px]">
              Стоимость доставки товаров определяется исходя из веса, габаритов
              удаленности до места назначения. Доставка осуществляется до
              подъезда дома, офиса.
            </p>
            <h2 className="text-[#2c333d] text-2xl !font-bold md:text-[18px]">
            ...
            <p className="text-[#2c333d] text-[20px] leading-7 !font-bold md:text-[16px]">
              1. Самовывоз с территории компании.
            </p>
            <p className="md:text-[15px] text-[#1e1e1e] leading-7 font-sans text-[19px]">
              ...
              по адресу: г.Черкесск, ул.Октябрьская, 301
            </p>
            <h5 className="text-[#1e1e1e] font-sans text-[20px] leading-7 !font-bold md:text-[16px]">
              Режим работы:
            </h5>
            ...
            <p className="md:text-[15px] text-[#1e1e1e] leading-7 font-sans text-[18.5px]">
            ...
            <p className="md:text-[15px] text-[#1e1e1e] leading-7 font-sans text-[19px] !w-[320px] max-md:w-[365px]">
              ...
              предлагает быструю и выгодную доставку по г.Черкесску и регионам
              Карачаево-Черкесской республики.
            </p>
            <p className="md:text-[15px] text-[#1e1e1e] leading-7 font-sans text-[18.5px]">
              На отправку интернет-заказов собственным транспортом компании,
              действует скидка -25%.Доставка товаров весом до 20 кг. возможна
              через сервис «Яндекс Такси» согласно тарифу перевозчика.
            </p>
            <p className="md:text-[15px] text-[#1e1e1e] leading-7 font-sans text-[19px]">
              Мы доставляем заказы с 8:00 до 18:00. Время и день согласовывается
            ...
            <ul className="relative left-8 flex gap-5 flex-col w-[300px] md:w-full">
              ...
              <li className="list-disc !hover:text-[#1e1e1e] marker:text-red-500 md:text-[14px] md:w-[1150px] leading-7 font-sans text-[17px] w-[320px]">
                При доставке просьба обеспечить свободный подъезд к планируемому
                месту разгрузки.
              </li>
              <li className="list-disc !hover:text-[#1e1e1e] marker:text-red-500 md:text-[14px] md:w-[1150px] leading-7 font-sans text-[17px] w-[320px]">
            ...
            <p className="md:text-[15px] text-[#1e1e1e] leading-7 font-sans text-[19px]">
              Если у Вас возникнут вопросы по качеству или количеству товара, Вы
              можете обратиться за разъяснениями по номеру телефона
              +7(8782)-28-42-72.
            </p>
            ...
            <p className="md:text-[15px] text-[#1e1e1e] leading-7 font-sans text-[19px]">
              ...
              компаний г.Черкесска, мы доставляем ваш заказ-бесплатно. Доставка
              осуществляется транспортными компаниям «СДЭК» и «ГлавДоставка».
              При оформлении заказа, Вы можете сообщить менеджеру желаемую
              транспортную компанию.
            </p>
            <p className="!font-bold text-[16px] text-[#2c333d]">
              4.Почтой России.
            </p>
            <p className="md:text-[15px] text-[#1e1e1e] leading-6 font-sans text-[19px]">
              Способы получения заказа Почтой России:
            </p>
            <ul className="relative left-8 w-[300px] md:w-full">
              <li className="list-disc !hover:text-[#1e1e1e] marker:text-red-500 md:text-[14px] md:w-[1150px] leading-7 font-sans text-[17px] w-[320px]">
                Самовывоз из отделения почтовой связи. Ваши заказы доставляются
                до выбранного почтового отделения
              </li>
              <li className="list-disc !hover:text-[#1e1e1e] marker:text-red-500 md:text-[14px] md:w-[1150px] leading-7 font-sans text-[17px] w-[320px]">
                Курьером на дом
              </li>
            ...
            <p className="md:text-[15px] text-[#1e1e1e] leading-7 font-sans text-[19px]">
              Наша компания понимает и ценит Ваше время, поэтому оперативная
              доставка приобретенных товаров, дает возможность как можно быстрее
              завершить ремонт и, наконец, взглянуть с восхищением на
