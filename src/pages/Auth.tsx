...
import { useNavigate } from '../link/motionLink';
          ...
          <div className='mt-20 lg:!ml-20 border w-full lg:!w-[88%] rounded-lg gap-5 border-gray-200 flex items-center justify-center max-sm:flex-col max-sm:mt-10 lg:gap-20 max-sm:gap-0 max-sm:ml-0 max-sm:w-full max-sm:p-5 md:mt-10 md:ml-0 md:w-full md:p-5 lg:p-10'>
            ...
            <div className='flex flex-col items-start md:w-[43%] w-full max-sm:mt-5'>
              ...
              <div className='flex flex-wrap flex-col ml-11 lg:ml-18 mt-7 max-sm:mt-3 md:mt-1'>
                ...
                <p className='!mt-5 text-sm flex flex-wrap leading-7 text-gray-500 md:!mt-0'>
                  Мы запрашиваем у вас только информацию, необходимую для того, чтобы сделать процесс покупки более быстрым и легким.
                </p>
                <Link
                  className='flex items-center justify-center rounded-sm text-white !h-[60px] lg:!mt-8 lg:w-3xs !bg-black !text-sm !uppercase hover:!bg-orange-700 transition-all'
                  to={"/register"}
                >Зарегистрироваться
                  <RightIcon size={30} />
                </Link>
