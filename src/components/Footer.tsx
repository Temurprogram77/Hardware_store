      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-8 py-10 border-b border-gray-300 text-sm">
        ...
        <div>
          ...
          <ul className="space-y-1">
            ...
            <li>
              <a href="#">Спецодежда и средства защиты</a>
            </li>
            <li>
              <a href="#">Метизы, такелаж и скобяные изделия</a>
            </li>
          </ul>
        </div>
      </div>
        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          <div className="flex items-center gap-7 relative left-">
            <img
              src={images.visa}
              alt="Visa"
              className="w-13 grayscale contrast-0 cursor-pointer hover: transition duration-300"
            />
            <img
              src={images.v}
              alt="MasterCard"
              className="w-13 grayscale contrast-0"
            />
            <img
              src={images.mir}
              alt="MIR"
...
=======
        <div className="w-full max-w-md flex items-center gap-2">
          <p className=" text-[15px] ">
            Подпишитесь на рассылкуи будьте в курсе!
          </p>
          <input
            type="email"
            placeholder="Ваш email"
...
>>>>>>> 9ff2fbb08ba39f7cbcfaf66cc79aa93d1e02233f
        </div>
      </div>
